...
public static class Refs1
{
    ...
    public static void Heal(ref int health, int amount)
    {
    ...
    public static ref int Slot(int[] inventory, int index)
    {
        return ref inventory[index];
    }

    public static ref Particle Oldest(Particle[] particles)
    {
        int best = 0;
