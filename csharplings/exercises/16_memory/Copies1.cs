...
public struct FrozenStats
{
    ...
    public FrozenStats WithAttack(int attack)
    {
        Attack = attack;
    ...
    public FrozenStats Buffed(int bonus)
    {
        Attack += bonus;
...
public static class Copies1
{
    ...
    private static MutableStats Frozen = new MutableStats { Attack = 1 };

    public static int BumpThroughIn(MutableStats stats) => stats.Bump();
